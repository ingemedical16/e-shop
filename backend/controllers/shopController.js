...
// @access  Public
export const loginShop = asyncHandler(
    async (req, res, next) => {
        try {
...
// @access  Public
export const getSeller = asyncHandler(
    async (req, res, next) => {
        try {
...
// @access  Public
export const getShopInfoById = asyncHandler(
    async (req, res, next) => {
        try {
...
// @access  Public
export const updateShopAvatar = asyncHandler(
    async (req, res, next) => {
        try {
...
// @access  Public
export const updateSellerInfo = asyncHandler(
    async (req, res, next) => {
        try {
...
// @access  Admin
export const getAllSeller = asyncHandler(
    async (req, res, next) => {
        try {
...
// @access  Public
export const deleteWithdrawMethod = asyncHandler(
    async (req, res, next) => {
        try {
            const seller = await Shop.findById(req.seller._id);
